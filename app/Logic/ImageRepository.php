...
class ImageRepository {
    ...
    private $full_save_path = 'public/uploads/images';
    ...
    public function resizeImage( $photo, $filename,$width='',$height='')
    {$path = storage_path('app/uploads/images/');
        $dataSize = getimagesize($photo);
        $getWidth=$dataSize[0];
        ...
        $manager = new ImageManager();
        $image = $manager->make( $photo )->resize($width, $height)->save( $path  . $filename );
        return $image;
    }
