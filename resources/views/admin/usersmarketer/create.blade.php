...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.usersmarketer.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('name', $marketer->fullname, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::email('email',$marketer->email, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('email'))
                        <p class="help-block">
                            {{ $errors->first('email') }}
