...
@section('content')
    ...
    {!! Form::model($item, ['method' => 'POST', 'route' => ['admin.consultation.sendMsg.send'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="flash-message">
                ...
                <div class="row">
                    ...
                    {!! Form::label('details', 'تفاصيل الاستشارة', ['class' => 'control-label']) !!}
                    <textarea class="form-control " disabled>{{@$item->details}}</textarea>

                     </div>   
                <input type="hidden" name="email" value="{{$item->email}}">
                <input type="hidden" name="id" value="{{$item->id}}">
                <div class="col-xs-12 form-group">
                    {!! Form::label('msg', trans('global.consultation.fields.msg').'', ['class' => 'control-label']) !!}
