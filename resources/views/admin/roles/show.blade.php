    ...
    <thead>
        <tr>
            <th>@lang('quickadmin.users.fields.name')</th>
                        ...
                        <th>@lang('quickadmin.users.fields.type')</th>
                        <th>@lang('quickadmin.users.fields.college')</th>
                                                <th>&nbsp;</th>
            ...
            @foreach ($users as $user)
                <tr data-entry-id="{{ $user->id }}">
                    <td field-key='name'>{{ $user->name }}</td>
                                ...
                                <td field-key='type'>{{ $user->type }}</td>
                                <td field-key='college'>{{ $user->college->name or '' }}</td>
                                                                <td>
                                    @can('view')
